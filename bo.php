 <?php
ob_start();
define('API_KEY','7291428449:AAFZOtoy6-c1L4w8CYBUsHu9_5m6zPccgYI');
$sudo = 5016340716;//ايديك تلي
$admin = "5016340716";//ايديك تلي
...
if(strstr($text,"tiktok") or strstr($text,"instagram") or strstr($text,"facebook")) {
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"يتم التحميل 
",
...
$api = file_get_contents("https://dev-tkx1.pantheonsite.io/z.php?u=".$text);
bot('sendvideo',[
'chat_id'=>$chat_id,
'video'=>$api,
'caption'=>"كليشة",
